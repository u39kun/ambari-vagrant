...
mv node-v0.10.40-linux-x64 /usr/share/node
/usr/share/node/bin/npm install -g brunch@1.7.20
wget --no-check-certificate http://pypi.python.org/packages/2.6/s/setuptools/setuptools-0.6c11-py2.6.egg
sh setuptools-0.6c11-py2.6.egg
wget http://apache.cs.utah.edu//maven/binaries/apache-maven-3.0.5-bin.tar.gz
